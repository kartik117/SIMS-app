...
class NavBar(tk.Frame):
    def __init__(self, parent, controller): 
        ...
        nav_button=tk.Button(self, text='Add Students', width=25, bg='#f3f3f4', bd=0, anchor=tk.W,
        ...
        nav_button=tk.Button(self, text='Add Courses', width=25, bg='#f3f3f4', bd=0, anchor=tk.W,
                          command=lambda: self.add_course())
        nav_button.grid(row=4, column=0, sticky=tk.W, padx=30, pady=10)
